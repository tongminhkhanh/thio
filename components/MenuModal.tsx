            ...
            <div className="bg-gradient-to-r from-amber-50 to-orange-50 p-4 rounded-xl border border-amber-100 shadow-sm relative overflow-hidden">
               ...
               <div className="relative z-10 space-y-3">
                 <div className="flex justify-between items-center border-b border-amber-200/50 pb-2">
                    ...
                    <span className="font-bold text-slate-800 text-sm">Techcombank</span>
                 </div>
                 <div className="flex justify-between items-center border-b border-amber-200/50 pb-2">
                    <span className="text-slate-500 text-xs font-medium">Số tài khoản</span>
                    <div className="flex items-center gap-2">
                         <span className="font-bold text-slate-900 font-mono text-base">554646686868</span>
                         <button onClick={() => navigator.clipboard.writeText("554646686868")} className="text-amber-600 hover:text-amber-700" title="Sao chép">
                 ...
                 <div className="flex justify-between items-center pt-1">
                    ...
                    <span className="font-bold text-slate-900 text-sm uppercase">DONG MINH PHU</span>
                 </div>

                 {/* QR Code Addition */}
                 <div className="mt-4 pt-4 border-t border-amber-200/50 flex flex-col items-center">
                    <p className="text-[10px] text-slate-500 mb-2 font-medium uppercase tracking-wider">Quét mã QR để chuyển khoản</p>
                    <div className="bg-white p-2 rounded-lg shadow-sm border border-amber-100">
                        <img 
                            src="https://img.vietqr.io/image/TCB-554646686868-compact.png" 
                            alt="QR Techcombank 554646686868"
